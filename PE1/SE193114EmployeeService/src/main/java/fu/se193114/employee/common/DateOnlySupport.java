...
/**
 * Date-only conversions shared by the JSON serializer and deserializer. Everything
 * resolves in the JVM default zone, which is the zone Hibernate uses when mapping the
 * SQL DATE column, so a day never shifts on the way in or out.
 */
